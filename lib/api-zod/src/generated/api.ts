...
export const CreateControlBody = zod.object({
  ...
  "inherentRiskScore": zod.number().optional(),
  "withinAppetite": zod.boolean().optional(),
  "overallRiskLevel": zod.enum(['High', 'Medium', 'Low']).optional(),
  "implementationStatus": zod.enum(['Implemented', 'In Progress', 'Overdue', 'Draft', 'Awaiting Review', 'Escalated']).optional(),
  "riskDescription": zod.string().optional(),
  "controlDescription": zod.string().optional(),
  "actor": zod.string().optional(),
  "actorRole": zod.string().optional()
})
 ...
 */
export const UpdateControlFieldsParams = zod.object({
  "controlId": zod.coerce.string()
})

export const UpdateControlFieldsBody = zod.object({
  ...
  "inherentRiskScore": zod.number().optional(),
  "withinAppetite": zod.boolean().optional(),
  "overallRiskLevel": zod.string().optional(),
  "implementationStatus": zod.string().optional(),
  "riskDescription": zod.string().optional(),
  "controlDescription": zod.string().optional(),
  "actor": zod.string().optional(),
...
export const UpdateControlFieldsResponse = zod.object({
  "id": zod.string(),
  "tenantId": zod.string(),
  "department": zod.string(),
  "departmentId": zod.string(),
 ...
 */
export const ImportControlsParams = zod.object({
  "tenantId": zod.coerce.string()
})

export const ImportControlsBody = zod.object({
  ...
  "overallRiskLevel": zod.string().optional(),
  "implementationStatus": zod.string().optional(),
  "withinAppetite": zod.string().optional(),
  "residualRiskScore": zod.number().optional(),
  "inherentRiskScore": zod.number().optional(),
  "riskDescription": zod.string().optional(),
  "controlDescription": zod.string().optional()
...
export const ImportControlsResponse = zod.object({
  "inserted": zod.number(),
 ...
 */
export const ExportControlsParams = zod.object({
  "tenantId": zod.coerce.string()
})
